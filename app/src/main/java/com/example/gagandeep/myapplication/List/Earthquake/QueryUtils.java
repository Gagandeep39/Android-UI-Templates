...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> earthquakeUtils() {

        ArrayList<Earthquake> earthquakes = new ArrayList<>();
        try {
            JSONObject base = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray array = base.getJSONArray("features");
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "problem with Htttp", e);
    ...
    try{
        ...
        Log.e("Query Utils", "Problem parsing earthquake", e);
    }
    return earthquakes;
    ...
    private static String makeHttpsRequest(URL url) throws IOException{
        ...
        try {
            ...
            connection.connect();
            //OCRRC = openconnection, setConnectTimeout, setRequestMethod, setReadTimeout, connect
